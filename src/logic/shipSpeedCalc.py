...
def c12_calcs(T, length) -> float: #correct
	"""
...
def c7_calcs(beam, length)->float | None:
	"""
...
if __name__ == "__main__":
	...
	ship = Ship()
	ship.hull.length(240)
	ship.hull.beam(30)
	ship.hull.draft(10)
	ship.hull.displacement(40000)
	main(ship)
	ship.hull.length(180)
	ship.hull.beam(20)
	ship.hull.draft(6)
	ship.hull.displacement(10000)
	main(ship)
	ship.hull.length(120)
	ship.hull.beam(12)
	ship.hull.draft(4)
	ship.hull.displacement(3000)
	main(ship)
